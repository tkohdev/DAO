...
//      script.src = '../../dist/genesys-cloud-webrtc-sdk.js';
  ...
  <script>
    window.environments = {
      ...
      'seoul_GSNeotek': {
        clientId: 'ff55d9b3-487f-4b14-8d46-1982da567bc1', // created in GSNeotek seoul org
        uri: 'apne2.pure.cloud'
      },
      'DGB_Seoul': {
        clientId: '0cf78b14-0fef-4998-9e41-88f611aca526', // created in dgb seoul org
        uri: 'apne2.pure.cloud'
      },
      'tokyo-GSNeotek': {
        clientId: 'b21e31e0-67d5-4239-bcb0-9b29bd40f5fd', // created in GSNeotek tokyo org
        uri: 'mypurecloud.jp'
      },
      'LGUPLUS': {
        clientId: '74e002c0-6bae-4fba-93fc-e39b269efc5a', // created in LGUPLUS
        uri: 'apne2.pure.cloud'
      }
    };
								...
								<div class="row no-gutters align-items-center">
									<div class="col mr-2">
										<div
											...
											<h4>
												1. Region 선택<br>2. Genesys Cloud login<br>3. Input SDK<br>4. Click 실행
											</h4>
										</div>
									</div>
									<div class="col mr-2">
										<div>
											...
											<select	class="form-control form-control-sm mb-2" id="environment" name="environment">
												<option value="seoul">Coupang_Seoul</option>
												<option value="seoul_GSNeotekl">GSNeotek_Seoul</option>
												<option value="tokyo-GSNeotek">GSNeotek_Tokyo</option>
                                                                                                                                                 <option value="DGB_Seoul">DGB_Seoul</option>
                                                                                                                                                 <option value="LGUPLUS">LGUPLUS_Seoul</option>
											</select>
										</div>
										<div>
											<form id="manual-form">
...
-->
										...
										<div>
											<label class="h5 mb-0 font-weight-bold text-gray-800" for="environment">Auth Token</label>
											<input class="form-control mb-2" style="border:none" id="manual-auth1" readonly>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card-body">
								<div class="row no-gutters align-items-center">
									<div class="col mr-2">
										...
										<div>
											<button class="btn btn-success" id="function excute" type="button" onclick="GetFunction()">실행</button>
										</div>
									</div>
								</div>
							</div>
