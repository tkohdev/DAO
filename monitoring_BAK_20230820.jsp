                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <h2>Last 6 Hours Avg. per Hours</h2>                                            
                                            </div>
...
function UsageChart(){
	...
	const s_date2 = s_date.setHours(s_date.getHours() - 6);
//	const s_date2 = s_date.setMinutes(s_date.getMinutes() - 30);
...
//	const today_d = today.getDate();
	...
	const e_seconds = "00";
//	const e_seconds = ('0' + e_date.getSeconds()).slice(-2);
	const s_hours = ('0' + s_date.getHours()).slice(-2);
	const s_minutes = ('0' + s_date.getMinutes()).slice(-2);
//	const s_seconds = ('0' + s_date.getSeconds()).slice(-2);

    if(e_c_hours<6){
    	var today_e_y = today.getFullYear();
    	var today_e_m = today.getMonth()+1;
    	var today_e_d = today.getDate();
    	var today_s_y = today.getFullYear();
    	var today_s_m = today.getMonth()+1;
    	var today_s_d = today.getDate()-1;
    }else{
    	var today_e_y = today.getFullYear();
    	var today_e_m = today.getMonth()+1;
    	var today_e_d = today.getDate();
	...
	console.log("http://211.168.177.225/api/historicdata.json?id=2140&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=E3FLTLRGVACPA6MKEHEUOLBL2HB42O6KO2CTFDGGCQ======");
    fetch("http://211.168.177.225/api/historicdata.json?id=2140&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=E3FLTLRGVACPA6MKEHEUOLBL2HB42O6KO2CTFDGGCQ======")
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		fetch("http://211.168.177.225/api/historicdata.json?id=2140&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=E3FLTLRGVACPA6MKEHEUOLBL2HB42O6KO2CTFDGGCQ======")
    ...
    .then((response) => {
       //Trunk01의 데이터를 불러온다
        ...
        return fetch("http://211.168.177.225/api/historicdata.json?id=2141&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=E3FLTLRGVACPA6MKEHEUOLBL2HB42O6KO2CTFDGGCQ======"); //trunk02의 센서 데이터를 받아온다
      })
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		fetch("http://211.168.177.225/api/historicdata.json?id=2141&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=E3FLTLRGVACPA6MKEHEUOLBL2HB42O6KO2CTFDGGCQ======")
            	}while(response.status == "200");
    	}else{
    		return response.json();
    	}
    ...
    .then((response) => {
        ...
        return fetch("http://211.168.177.225/api/historicdata.json?id=2152&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=E3FLTLRGVACPA6MKEHEUOLBL2HB42O6KO2CTFDGGCQ======"); //trunk01 outbound 데이터
      })
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		fetch("http://211.168.177.225/api/historicdata.json?id=2152&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=E3FLTLRGVACPA6MKEHEUOLBL2HB42O6KO2CTFDGGCQ======")
        	}while(response.status == "200");
    	}else{
    		return response.json();
    	}
    ...
    .then((response) => {
        ...
        return fetch("http://211.168.177.225/api/historicdata.json?id=2153&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=E3FLTLRGVACPA6MKEHEUOLBL2HB42O6KO2CTFDGGCQ======"); //trunk02 outbound 데이터
      })
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		fetch("http://211.168.177.225/api/historicdata.json?id=2153&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=E3FLTLRGVACPA6MKEHEUOLBL2HB42O6KO2CTFDGGCQ======")
        	}while(response.status == "200");
    	}else{
    		return response.json();
    	}
    ...
    .then((response) => {
        ...
        return trunkout02_05; //trunk02 outbound 데이터
      })       
    .then(data => {
	...
	var ctx_out = document.getElementById("myAreaChart");
  	...
  	var myLineChart = new Chart(ctx_in, {
  	  type: 'line',
  	  data: {
  	    labels: [Time_01, Time_02, Time_03, Time_04, Time_05, Time_06],
  	    datasets: [{
  	      label: "Inbond",
  	      lineTension: 0.3,
  	      ...
  	      pointHitRadius: 10,
  	      pointBorderWidth: 2,
  	      data: [In_01, In_02, In_03, In_04, In_05, In_06],
  	    },
  	  {
  	      label: "Oubond",
  	      lineTension: 0.3,
  	      ...
  	      pointHitRadius: 10,
  	      pointBorderWidth: 2,
  	      data: [Out_01, Out_02, Out_03, Out_04, Out_05, Out_06],
  	    }],
  	  },
  	  options: {
