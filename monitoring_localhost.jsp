...
function LGTotalCuncurrent(){
    ...
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
        		fetch("http://10.0.246.138/api/getsensordetails.json?id=2146&apitoken=PC2GDZSNJYAYLNXEOA34GARMDVFTDU5PXZZ4OMXOIY======")
        	}while(response.status == "200");
    		return response.json();
    	}else{
    		return response.json();
    ...
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
        		fetch("http://10.0.246.138/api/getsensordetails.json?id=2155&apitoken=PC2GDZSNJYAYLNXEOA34GARMDVFTDU5PXZZ4OMXOIY======")
        	}while(response.status == "200");
    		return response.json();
    	}else{
    		return response.json();
    ...
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
        		fetch("http://10.0.246.138/api/getsensordetails.json?id=2156&apitoken=PC2GDZSNJYAYLNXEOA34GARMDVFTDU5PXZZ4OMXOIY======")
        	}while(response.status == "200");
    		return response.json();
    	}else{
    		return response.json();
    ...
    .then((response) => {
        ...
        return fetch("http://10.0.246.138/api/getsensordetails.json?id=2148&apitoken=LQS7MOZOLZV6W7W3UB6GSZB3S2D2ZYBQIT2AYNZXLQ======")
      })   
    .then((response) => {
    	if(response.status != "200"){
        	do{
    ...
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
        		fetch("http://10.0.246.138/api/getsensordetails.json?id=2149&apitoken=LQS7MOZOLZV6W7W3UB6GSZB3S2D2ZYBQIT2AYNZXLQ======")
        	}while(response.status == "200");
    		return response.json();
    	}else{
    		return response.json();
    ...
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
        		fetch("http://10.0.246.138/api/getsensordetails.json?id=2158&apitoken=LQS7MOZOLZV6W7W3UB6GSZB3S2D2ZYBQIT2AYNZXLQ======")
        	}while(response.status == "200");
    		return response.json();
    	}else{
    		return response.json();
    ...
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
        		fetch("http://10.0.246.138/api/getsensordetails.json?id=2159&apitoken=LQS7MOZOLZV6W7W3UB6GSZB3S2D2ZYBQIT2AYNZXLQ======")
        	}while(response.status == "200");
    		return response.json();
    	}else{
    		return response.json();
    ...
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
        		fetch("http://10.0.246.138/api/getsensordetails.json?id=2150&apitoken=LQS7MOZOLZV6W7W3UB6GSZB3S2D2ZYBQIT2AYNZXLQ======")
        	}while(response.status == "200");
    		return response.json();
    	}else{
    		return response.json();
    ...
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
        		fetch("http://10.0.246.138/api/getsensordetails.json?id=2151&apitoken=LQS7MOZOLZV6W7W3UB6GSZB3S2D2ZYBQIT2AYNZXLQ======")
        	}while(response.status == "200");
    		return response.json();
    	}else{
    		return response.json();
    ...
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
        		fetch("http://10.0.246.138/api/getsensordetails.json?id=2160&apitoken=LQS7MOZOLZV6W7W3UB6GSZB3S2D2ZYBQIT2AYNZXLQ======")
        	}while(response.status == "200");
    		return response.json();
    	}else{
    		return response.json();
    ...
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
        		fetch("http://10.0.246.138/api/getsensordetails.json?id=2161&apitoken=LQS7MOZOLZV6W7W3UB6GSZB3S2D2ZYBQIT2AYNZXLQ======")
        	}while(response.status == "200");
    		return response.json();
    	}else{
    		return response.json();
...
function UsageChart(){
	...
	console.log("http://10.0.246.138/api/historicdata.json?id=2140&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=GOHCPASGCQF2A57X5BGRSSNZVVKXETR2LJM3ZJMUBI======");
    fetch("http://10.0.246.138/api/historicdata.json?id=2140&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=GOHCPASGCQF2A57X5BGRSSNZVVKXETR2LJM3ZJMUBI======")
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
    ...
    .then((response) => {
       //Trunk01의 데이터를 불러온다
        ...
        return fetch("http://10.0.246.138/api/historicdata.json?id=2141&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=GOHCPASGCQF2A57X5BGRSSNZVVKXETR2LJM3ZJMUBI======"); //trunk02의 센서 데이터를 받아온다
      })
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
        		fetch("http://10.0.246.138/api/historicdata.json?id=2141&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=GOHCPASGCQF2A57X5BGRSSNZVVKXETR2LJM3ZJMUBI======")
            	}while(response.status == "200");
    		return response.json();
    	}else{
    		return response.json();
    ...
    .then((response) => {
        ...
        return fetch("http://10.0.246.138/api/historicdata.json?id=2152&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=GOHCPASGCQF2A57X5BGRSSNZVVKXETR2LJM3ZJMUBI======"); //trunk01 outbound 데이터
      })
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
        		fetch("http://10.0.246.138/api/historicdata.json?id=2152&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=GOHCPASGCQF2A57X5BGRSSNZVVKXETR2LJM3ZJMUBI======")
        	}while(response.status == "200");
    		return response.json();
    	}else{
    		return response.json();
    ...
    .then((response) => {
        ...
        return fetch("http://10.0.246.138/api/historicdata.json?id=2153&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=GOHCPASGCQF2A57X5BGRSSNZVVKXETR2LJM3ZJMUBI======"); //trunk02 outbound 데이터
      })
    .then((response) => {
    	if(response.status != "200"){
        	do{
        		time.sleep(1);
        		fetch("http://10.0.246.138/api/historicdata.json?id=2153&avg=3600&sdate=" +s_timeStr+ "&edate=" +e_timeStr+"&usecaption=1&apitoken=GOHCPASGCQF2A57X5BGRSSNZVVKXETR2LJM3ZJMUBI======")
        	}while(response.status == "200");
    		return response.json();
    	}else{
    		return response.json();
